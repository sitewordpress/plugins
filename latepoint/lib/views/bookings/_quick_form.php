      ...
      <div class="transactions-info-w">
        ...
        <div class="quick-add-transaction-box-w" data-route="<?php echo OsRouterHelper::build_route_name('transactions', 'add_for_booking'); ?>">
          <div class="quick-add-transaction-box">
            ...
            <div class="os-row">
              <div class="os-col-lg-6">
                <?php echo OsFormHelper::text_field('transaction[amount]', false, '', ['placeholder' => __('Amount', 'latepoint')] ); ?>
              </div>
              <div class="os-col-lg-6">
                <?php echo OsFormHelper::text_field('transaction[created_at]', false, current_time('Y-m-d'), ['placeholder' => __('Date', 'latepoint')]); ?>
              </div>
            </div>
            <div class="os-row">
              <div class="os-col-12">
                <?php echo OsFormHelper::text_field('transaction[token]', false, '', ['placeholder' => __('Confirmation Number', 'latepoint')] ); ?>
              </div>
            </div>
            <div class="os-row">
              <div class="os-col-lg-6">
                <?php echo OsFormHelper::select_field('transaction[processor]',false , ['stripe' => 'Stripe', 'braintree' => 'BrainTree', 'paypal' => 'PayPal', 'other' => 'Other'], false, ['placeholder' => __('Processor', 'latepoint')]); ?>
              </div>
              <div class="os-col-lg-6">
                <?php echo OsFormHelper::select_field('transaction[payment_method]', false, ['card' => 'Card', 'paypal' => 'PayPal', 'cash' => 'Cash', 'other' => 'Other'], false, ['placeholder' => __('Method', 'latepoint')]); ?>
              </div>
            </div>

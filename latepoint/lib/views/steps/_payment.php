<div class="step-payment-w latepoint-step-content <?php echo $payment_css_class; ?>" 
  ...
  <?php
    echo OsFormHelper::hidden_field('booking[payment_method]', $booking->get_default_payment_method(), [ 'class' => 'latepoint_payment_method', 'skip_id' => true]);
    echo OsFormHelper::hidden_field('booking[payment_token]', $booking->payment_token, [ 'class' => 'latepoint_payment_token', 'skip_id' => true]);
    echo OsFormHelper::hidden_field('booking[payment_portion]', $booking->payment_portion, [ 'class' => 'latepoint_payment_portion', 'skip_id' => true]);
  ?>
</div>